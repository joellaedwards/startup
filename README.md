...
- [X] **Stores data in MongoDB** - I store saved games in MongoDB. I save all the games, but only display the most recent 10.
- [X] **Stores credentials in MongoDB** - Usernames and tokens stored in MongoDB.
